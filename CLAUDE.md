...
# Generate for a specific tool + provider
...
| 0 Foundation | `lore-product-strategist` | glossary-manager (or discovery-manager for combined 0-1) |
| 1 Discovery | `lore-product-strategist` | spec-manager → adr-manager (or discovery-manager) |
